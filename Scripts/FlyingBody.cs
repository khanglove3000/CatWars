...
{
   public static void Create(Transform CatPrefab, Vector3 spawnPosition, Vector3 flyDirection) 
    {
        Transform flyingBodyTransform = Instantiate(CatPrefab, spawnPosition, Quaternion.identity);
